...
// export default class DropDownList extends LightningElement {
// 	isOpen = false;
...
export default class PriceRangeSelector extends LightningElement {
    @track minPrice = '';
    @track maxPrice = '';
    @track showDropdown = false;
    @track showInput = false;

    priceRanges = ['0 - 100', '100 - 500', '500 - 1000', '1000 - 5000']; // Add more options as needed
    ...
    setPriceRange(event) {
        const selectedRange = event.target.textContent;
        [this.minPrice, this.maxPrice] = selectedRange.split(' - ');
